...
from model.scale_dot_product_attention import ScaleDotProductAttention
...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, d_model, n_head):
        ...
        # Concat all attention heads output and mapping it to original dimension
        self.w_concat = nn.Linear(d_model, d_model)

    '''
    q, k, v: query, key and value
    mask: mask some of attnetion weights
    '''
